...
@section('content')
    <div class="card">
        <div class="card-content">
            ...
            <span class="card-title center">Registrar Vehículo</span>
            ...
            <form action="{{ route('vehiculos.store') }}" method="POST">
                ...
                <div class="input-field">
                    ...
                    <input type="number" name="año" id="año" min="1900" max="{{ date('Y') }}" required>
                    <label for="año">Año de Fabricación</label>
                </div>

                <div class="input-field">
                    <i class="material-icons prefix">build</i>
                    <input type="number" name="ejes" id="ejes" min="2" required>
                ...
                <div class="input-field">
                    ...
                    <select name="tipo_uso" id="tipo_uso" required>
                        <option value="" disabled selected>Seleccione el Tipo de Uso</option>
                ...
                <div class="input-field">
                    ...
                    <input type="number" name="valor_fiscal" id="valor_fiscal" step="0.01" required>
