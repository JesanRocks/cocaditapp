...
<body class="antialiased">
    <div
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            <form action="{{ route('contribuyente.logout') }}" method="post">
                @CSRF 
                <button
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Opcion 1</h2>
                    ...
                    <a href="https://laracasts.com"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Opcion 2</h2>
                    ...
                    <a href="https://laravel-news.com"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Opcion 3</h2>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Opcion 4</h2>
